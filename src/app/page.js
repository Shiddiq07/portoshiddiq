  ...
  return (
    <>
      <div className="">
        ...
        <h1 className=" text-6xl font-sans md:Apple Color Emoji text-yellow-600/100 " > Saya Jabal Jala Raga </h1>
        <h1 className=" text-6xl font-sans md:Apple Color Emoji" >Data Analys</h1>
        <div>
